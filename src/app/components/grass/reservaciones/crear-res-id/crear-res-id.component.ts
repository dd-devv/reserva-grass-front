...
@Component({
  selector: 'app-crear-res-id',
  templateUrl: './crear-res-id.component.html',
  styleUrls: ['./crear-res-id.component.css']
})


export class CrearResIdComponent implements OnInit {
  public id: any;
  public id_user: any;
  public token: any;
  ...
  public monto_reserva: number | undefined;
      ...
      this._userService.registro_reservacion_grass(data, this.token).subscribe(
        response => {
          if (response.data == undefined) {
            ...
            this._router.navigate(['/grass/reservaciones']);
          }
        }
      );
